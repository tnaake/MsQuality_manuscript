...
after removing zero-length and zero-intensity entries, complying
...
user-friendly: (i)  after the instantiation of 
\texttt{Spectra} or \texttt{MsExperiment}
object, a single function call is needed to calculate the quality metrics; 
(ii) the metrics can be interactively explored via a shiny application.
...
It offers easy-to-use means of evaluating data quality, 
enabling researchers the identification of low-quality measurements.
