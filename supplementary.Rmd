...
.path <- "/g/huber/users/naake/GitHub/MsQuality_manuscript/Cherkaoui2022/peak/New_mzMLFinal"
...
.metrics_sps <- MsQuality::calculateMetricsFromSpectra(spectra = sps, 
    metrics = .metrics)
saveRDS(.metrics_sps, file = "data/Cherkaoui2022_metrics_sps.RDS")
```
...
## save the data.frame
saveRDS(df_ram, file = "data/Cherkaoui2022_df_ram.RDS")
```
...
- http://proteomecentral.proteomexchange.org/cgi/GetDataset?ID=PXD000320 
  (`1_of_5`),
- http://proteomecentral.proteomexchange.org/cgi/GetDataset?ID=PXD000321
  (`2_of_5`),
- http://proteomecentral.proteomexchange.org/cgi/GetDataset?ID=PXD000322
  (`3_of_5`),
- http://proteomecentral.proteomexchange.org/cgi/GetDataset?ID=PXD000323
  (`4_of_5`),
- http://proteomecentral.proteomexchange.org/cgi/GetDataset?ID=PXD000324
  (`5_of_5`).
