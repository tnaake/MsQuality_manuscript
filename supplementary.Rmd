...
gg_tic <- .metrics_sps_msLevel1 |>
    ...
    ggplot() +
        ...
        xlab("RT duration (s, in 10e3)") + ylab("area under TIC") +
        theme_classic() +
        theme(legend.position = "none")

ggpubr::ggarrange(gg_tic, ncol = 1, nrow = 1, labels = "AUTO")

## areaUnderTicRtQuantiles
## areaUnderTicRtQuantiles 25%
gg_tic25 <- .metrics_sps_msLevel1 |>
    ...
    ggplot(aes(x = rtDuration, y = value)) +
        ...
        facet_wrap(~ Curated_Quality, scales = "fixed") +
        xlab("") + ylab("area under TIC (25% RT quantile)") +
        theme_classic() +
        theme(legend.position = "none")

## areaUnderTicRtQuantiles 50%
gg_tic50 <- .metrics_sps_msLevel1 |>
    filter(!duplicated(rowname)) |>
    ...
    ggplot(aes(x = rtDuration, y = value)) +
        stat_density_2d(aes(color = Curated_Quality)) +
        facet_wrap(~ Curated_Quality, scales = "fixed") +
        xlab("") + ylab("area under TIC (50% RT quantile)") +
        theme_classic() +
        theme(legend.position = "none")

## areaUnderTicRtQuantiles 75%
gg_tic75 <- .metrics_sps_msLevel1 |>
    filter(!duplicated(rowname)) |>
    ...
    ggplot(aes(x = rtDuration, y = value)) +
        stat_density_2d(aes(color = Curated_Quality)) +
        facet_wrap(~ Curated_Quality, scales = "fixed") +
        xlab("RT duration (s, in 10e3)") + ylab("area under TIC (75% RT quantile)") +
        theme_classic() +
        theme(legend.position = "none")

## areaUnderTicRtQuantiles 100%
gg_tic100 <- .metrics_sps_msLevel1 |>
    filter(!duplicated(rowname)) |>
    ...
    ggplot(aes(x = rtDuration, y = value)) +
        stat_density_2d(aes(color = Curated_Quality)) +
        facet_wrap(~ Curated_Quality, scales = "fixed") +
        xlab("RT duration (s, in 10e3)") + 
        ylab("area under TIC (100% RT quantile)") +
        theme_classic() +
        theme(legend.position = "none")

ggpubr::ggarrange(gg_tic25, gg_tic50, gg_tic75, gg_tic100, ncol = 2, nrow = 2,
    labels = "AUTO")

## ticQuantileToQuantileLogRatio
## ticQuantileToQuantileLogRatio Q2/Q1%
gg_tic_q2 <- .metrics_sps_msLevel1 |>
    filter(!duplicated(rowname)) |>
    select(rowname, Curated_Quality, rtDuration, "ticQuantileToQuantileLogRatio.Q2/Q1") |>
    filter(Curated_Quality %in% c("good", "poor")) |>
    mutate(rtDuration = rtDuration / 1000) |>
    pivot_longer(cols = "ticQuantileToQuantileLogRatio.Q2/Q1") |>
    ggplot(aes(x = rtDuration, y = value)) +
        stat_density_2d(aes(color = Curated_Quality)) +
        facet_wrap(~ Curated_Quality, scales = "fixed") +
        xlab("") + ylab("TIC Q2 to Q1 log ratio") +
        theme_classic() +
        theme(legend.position = "none")

## ticQuantileToQuantileLogRatio.Q3/Q1
gg_tic_q3 <- .metrics_sps_msLevel1 |>
    filter(!duplicated(rowname)) |>
    select(rowname, Curated_Quality, rtDuration, "ticQuantileToQuantileLogRatio.Q3/Q1") |>
    filter(Curated_Quality %in% c("good", "poor")) |>
    mutate(rtDuration = rtDuration / 1000) |>
    pivot_longer(cols = "ticQuantileToQuantileLogRatio.Q3/Q1") |>
    ggplot(aes(x = rtDuration, y = value)) +
        stat_density_2d(aes(color = Curated_Quality)) +
        facet_wrap(~ Curated_Quality, scales = "fixed") +
        xlab("") + ylab("TIC Q3 to Q1 log ratio") +
        theme_classic() +
        theme(legend.position = "none")

## ticQuantileToQuantileLogRatio.Q4/Q1
gg_tic_q4 <- .metrics_sps_msLevel1 |>
    filter(!duplicated(rowname)) |>
    select(rowname, Curated_Quality, rtDuration, "ticQuantileToQuantileLogRatio.Q4/Q1") |>
    filter(Curated_Quality %in% c("good", "poor")) |>
    mutate(rtDuration = rtDuration / 1000) |>
    pivot_longer(cols = "ticQuantileToQuantileLogRatio.Q4/Q1") |>
    ggplot(aes(x = rtDuration, y = value)) +
        stat_density_2d(aes(color = Curated_Quality)) +
        facet_wrap(~ Curated_Quality, scales = "fixed") +
        xlab("") + ylab("TIC Q4 to Q1 log ratio") +
        theme_classic() +
        theme(legend.position = "none")

ggpubr::ggarrange(gg_tic_q2, gg_tic_q3, gg_tic_q4, ncol = 3, nrow = 1,
    labels = "AUTO")
```
...
.metrics_sps_msLevel1 |>
    ...
    ggplot(aes(x = log(rtDuration), y = log(RT_Duration))) +
        geom_point(aes(col = Curated_Quality), alpha = 0.2) +
        xlab("rtDuration (log, MsQuality)") + ylab("RT_Duration (log, Quameter)") +
        theme_classic() +
...
gg_rt_tic_q3 <- .metrics_sps_msLevel1 |>
    ...
    ggplot(aes(x = rtOverTicQuantile, y = RTTIC)) +
        ...
        xlab("rtOverTicQuantile (MsQuality)") + 
