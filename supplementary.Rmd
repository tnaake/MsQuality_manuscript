...
```{r rtOverTicQuantiles, fig.cap = "Scatterplot between quality metrics calculated by MsQuality and QuaMeter: RT over TIC quantile. The metrics are calculated from MS1 and MS2 spectra."}
## 
...
gg_rt_tic_q1_msLevel1 <- .metrics_sps_msLevel1 |>
    ...
    ggplot(aes(x = `rtOverTicQuantiles.25%`, y = RT_TIC_Q1)) +
        stat_density_2d() +
        xlab("rtOverTicQuantiles 25% (MS1, MsQuality)") + ylab("RT_TIC_Q1 (QuaMeter)") +
        theme_classic() +
        guides(colour = guide_legend(override.aes = list(alpha = 1)))
...
gg_rt_tic_q1_msLevel2 <- .metrics_sps_msLevel2 |>
    ...
    ggplot(aes(x = `rtOverTicQuantiles.25%`, y = RT_TIC_Q1)) +
        stat_density_2d() +
        xlab("rtOverTicQuantiles 25% (MS2, MsQuality)") + ylab("RT_TIC_Q1 (QuaMeter)") +
        theme_classic() +
        guides(colour = guide_legend(override.aes = list(alpha = 1)))
...
gg_rt_tic_q2_msLevel1 <- .metrics_sps_msLevel1 |>
    ...
    ggplot(aes(x = `rtOverTicQuantiles.50%`, y = RT_TIC_Q2)) +
        stat_density_2d() +
        xlab("rtOverTicQuantiles 50% (MS1, MsQuality)") + ylab("RT_TIC_Q2 (QuaMeter)") +
        theme_classic() +
        guides(colour = guide_legend(override.aes = list(alpha = 1)))
...
gg_rt_tic_q2_msLevel2 <- .metrics_sps_msLevel2 |>
    ...
    ggplot(aes(x = `rtOverTicQuantiles.50%`, y = RT_TIC_Q2)) +
        stat_density_2d() +
        xlab("rtOverTicQuantiles 50% (MS2, MsQuality)") + ylab("RT_TIC_Q2 (QuaMeter)") +
        theme_classic() +
        guides(colour = guide_legend(override.aes = list(alpha = 1)))
...
gg_rt_tic_q3_msLevel1 <- .metrics_sps_msLevel1 |>
    ...
    ggplot(aes(x = `rtOverTicQuantiles.75%`, y = RT_TIC_Q3)) +
        stat_density_2d() +
        xlab("rtOverTicQuantiles 75% (MS1, MsQuality)") + 
...
gg_rt_tic_q3_msLevel2 <- .metrics_sps_msLevel2 |>
    ...
    ggplot(aes(x = `rtOverTicQuantiles.75%`, y = RT_TIC_Q3)) +
        stat_density_2d() +
        xlab("rtOverTicQuantiles 75% (MS2, MsQuality)") + 
        ylab("RT_TIC_Q3 (QuaMeter)") +
        theme_classic() +
        guides(colour = guide_legend(override.aes = list(alpha = 1)))
...
gg_rt_tic_msLevel1 <- .metrics_sps_msLevel1 |>
    ...
    rename("Q1_rtOverTicQuantiles" = `rtOverTicQuantiles.25%`,
        "Q2_rtOverTicQuantiles" = `rtOverTicQuantiles.50%`,
        "Q3_rtOverTicQuantiles" = `rtOverTicQuantiles.75%`,
    ...
    ggplot(aes(x = rtOverTicQuantiles, y = RTTIC)) +
        ...
        xlab("rtOverTicQuantiles (MS1, MsQuality)") + 
...
gg_rt_tic_msLevel2 <- .metrics_sps_msLevel2 |>
    ...
    ggplot(aes(x = rtOverTicQuantiles, y = RTTIC)) +
        stat_density_2d(aes(color = Quantile)) +
        xlab("rtOverTicQuantiles (MS2, MsQuality)") + 
        ylab("RT_TIC (QuaMeter)") +
        xlim(0, 1) + ylim(0, 1) +
        theme_classic() +
        guides(colour = guide_legend(override.aes = list(alpha = 1)))
